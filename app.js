  ...
  return {
    ...
    addListItem: function(obj, type) {
      ...
      if (type === 'inc') {
        ...
        '21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i>'+
        '</button></div></div></div>';
      }
    ...
    delteListItem: function(selctorID) {
      var el;

      el = document.getElementById(selctorID);
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var updatePercentage = function() {
      // 1. Calculate percentatge 
      budgetCtrl.calulatePercentage();
  ...
  var ctrlDeleteItem = function(event) {
    ...
    if (itemID) {
      ...
      // split the ID of inc- or exp- from HTML string
